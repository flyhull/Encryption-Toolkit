...
{
    [TestClass]
    public sealed class PositiveExistingPngTests
    {
        ...
        public void BytesIntoExistingPngFileToPngBytesToBytes()
        {
            ...
            byte[] payload = TestingSupport.GetRandomNumberOfRandomBytes(ImageLimits.MinimumBytesToStoreInAnyPng, ImageLimits.MaximumBytesToStoreInModelPng);
